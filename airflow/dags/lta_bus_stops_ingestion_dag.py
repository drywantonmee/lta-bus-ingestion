...
# Define the path to the bus_stops_ingestion.py script
...
ingest_bus_stops_task = SparkSubmitOperator(
    ...
    conn_id='spark_default', # This connection needs to be configured in Airflow UI
    conf={"spark.driver.extraJavaOptions": "-Djava.security.manager=allow"},
    jars=jar_path,
    packages='org.postgresql:postgresql:42.7.3', # Ensure this matches the JAR version
    dag=dag,
)
